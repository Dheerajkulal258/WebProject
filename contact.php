...
<head>
        <title>Brownie Point|| Contact Us</title>
        ...
        <section class="contact_form_area p_100">
        	<div class="container">
        		<div class="main_title">
					<h2>Feedback</h2>
					<h5>Do you have anything in your mind to let us know?  Kindly don't delay to give review to us by means of our feedback form.</h5>
				</div>
       			<div class="row">
       				<div class="col-lg-7">
